...
import { editItem } from "../redux/slices/shoppingSlice";
...
export default function EditItemModal({ item, onClose }: EditItemModalProps) {
  ...
  const originalTotal = (item.quantity * item.price).toFixed(2);
  const newTotal =
    quantity &&
    price &&
    ...
    !isNaN(parseFloat(price))
      ...
      : null;
  const totalChanged = newTotal !== null && newTotal !== originalTotal;
          ...
          <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
            ...
            {newTotal && (
              <View
                style={[
                  styles.totalPreview,
                  totalChanged && styles.totalPreviewChanged,
                ]}
              >
                <View style={styles.totalCol}>
                  <Text style={styles.totalLabel}>Original</Text>
                  <Text
                    style={[
                      styles.totalValue,
                      totalChanged && styles.totalValueOld,
                    ]}
                  >
                    R{originalTotal}
                  </Text>
                ...
                {totalChanged && (
                  <>
                    ...
                    <View style={styles.totalCol}>
                      ...
                      <Text style={[styles.totalValue, styles.totalValueNew]}>
                        R{newTotal}
                      </Text>
                    </View>
                  </>
                ...
                {!totalChanged && (
                  <View style={styles.totalCol}>
                    ...
                    <Text style={styles.totalValue}>R{newTotal}</Text>
                  </View>
                )}
              </View>
            )}
...
const styles = StyleSheet.create({
  ...
  totalValueNew: { color: COLORS.accent },
  arrowIcon: {
    fontSize: FONT_SIZES.xl,
    color: COLORS.textMuted,
